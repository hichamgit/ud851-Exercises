...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String LIFECYCLE_CALLBACKS_TEXT_KEY = "LIFECYCLE_CALLBACKS_TEXT";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( (savedInstanceState!=null) && savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
            String previousLifecycleMsg = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
            mLifecycleDisplay.setText(previousLifecycleMsg);
        }
